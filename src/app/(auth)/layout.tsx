  ...
  return (
    <div className={`w-screen h-screen`}>
      <CrInstudiText
        ...
        isBlock={false}
      />
      <div className='-translate-y-[8.4%] overflow-hidden'>
        <svg
          className='translate-y-2.5 scale-110 rotate-3 pointer-events-none'
        ...
        <div className='bg-gradient-to-b h-[70vh] via-[#8366ff] from-[var(--primary-rgb)] to-[#c986ff]'>
          <div
            className='w-[86vw] pt-[5%] h-[80%] top-[10%] relative left-[7vw] shadow-xl 
          rounded-xl dark:bg-slate-800/90 bg-indigo-600/70'>
            {children}
          </div>
        </div>
        <svg
